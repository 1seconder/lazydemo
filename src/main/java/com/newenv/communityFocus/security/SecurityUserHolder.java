...
import com.newenv.communityFocus.configuration.ConfigConfiguration;
...
import com.newenv.communityFocus.services.UserLoginService;
...
public class SecurityUserHolder extends BaseService {
	...
	private static final Log logger = LogFactory.getLog(SecurityUserHolder.class);
	...
	private static ConfigConfiguration config;
	...
	public static ConfigConfiguration getConfig(){
		return config;
	}
