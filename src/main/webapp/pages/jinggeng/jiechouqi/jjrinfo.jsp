						...
						<div class="col-md-6 col-sm-6">
							<div class="form-group">
								<div class="input-group input-group-minimal">
									...
									<input class="form-control" type="text" id="lpAddress" value="${per.lpAddress }">
								</div>
							</div>
						</div>
...
<script type="text/javascript">
	...
	function save2(){
		...
		per.homeAddress = $("#juzhuAddress").val();
		per.lpAddress = $("#lpAddress").val();
		...
		req.livePersonCount =  $("#livePersonCount").val();
	...
	//rent.livePersonCount =  $("#livePersonCount").val();
		...
		$.ajax({
			...
			success: function(data){
	 			alert("操作成功");
	 			window.location.href = "<%=basePath%>/services/refineService/mainPage/2/" + r.fhid  +"/" + idx;
	 		}
		})
	}
